...
const signaturePort_1 = process.env.SIGNATURE_API_1_PORT || config.get('signature-api-port-1'); // '3005'
...
const signaturePort_2 = process.env.SIGNATURE_API_2_PORT || config.get('signature-api-port-2'); // '2998'
